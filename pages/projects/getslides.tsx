...
import ProjectGetSlidesImage from "public/assets/images/getslides-hero.png";
        ...
        <div className={`main`}> 
            ...
            <div className="w-screen h-[30vh] lg:h-[40vh] relative">
                ...
                <div className="absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2">
                    <h2 className="py-2">GetSlides - AI-Powered Presentation Generator</h2>
                    <h3>Nuxt.js / Vue.js / TailwindCSS / Slidev / OpenAI / Supabase</h3>
                </div>
            </div>
            <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-12 gap-8 py-14 px-8 md:px-20 dark:bg-gray-900 dark:text-gray-100">
                <div className="col-span-4 md:col-span-8">
                    <p className="text-3xl md:text-4xl">GetSlides Platform</p>
                    ...
                    <Link href="https://getslides-f3fau.ondigitalocean.app" target="_blank">
                        <button className="button px-8 py-2 mt-4 mr-8">Demo</button>
                    </Link>
                    <Link href="https://github.com/irvingzamora28/getslides" target="_blank">
                    ...
                    <div className="p-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-1">
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <RiRadioButtonFill className="mr-2" /> Nuxt.js 3
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaVuejs className="mr-2" /> Vue.js
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaCss3 className="mr-2" /> TailwindCSS
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaChalkboard className="mr-2" /> Slidev
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaRobot className="mr-2" /> OpenAI
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaDatabase className="mr-2" /> Supabase
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaNode className="mr-2" /> Node.js
                            </p>
                            <p className="flex items-center text-gray-600 dark:text-gray-400 py-2">
                                <FaTools className="mr-2" /> bun
                            </p>
                        </div>
                    </div>
                </div>
...
export default ProjectGetSlides;

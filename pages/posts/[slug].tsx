...
export async function getStaticPaths() {
    ...
    const slugs = ["blog1", "how-to-install-npm-using-nvm", "how-to-structure-nextjs-project", "benefits-of-continuous-integration-and-deployment", "tips-for-scaling-web-applications"];

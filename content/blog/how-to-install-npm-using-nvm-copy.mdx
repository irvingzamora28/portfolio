...
<CopyBlock language={`bash`} text={curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.0/install.sh | bash} startingLineNumber={1} wrapLines />
...
<CopyBlock language={`bash`} text={nvm --version} startingLineNumber={1} wrapLines />
...
<CopyBlock text={nvm install node} startingLineNumber={1} wrapLines />
...
<CopyBlock text={node --version} startingLineNumber={1} wrapLines />
...
<CopyBlock text={npm --version} startingLineNumber={1} wrapLines />
...
<CopyBlock text={nvm install-latest-npm} startingLineNumber={1} wrapLines />

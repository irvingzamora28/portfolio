...
<CopyBlock text={curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.0/install.sh | bash} startingLineNumber={1} wrapLines />
...
<CopyBlock text={nvm --version} startingLineNumber={1} wrapLines />
